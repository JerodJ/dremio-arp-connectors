...
@SourceType(value = "{Datasource}ARP", label = "{Datasource}",uiConfig = "{DatasourceLower}-layout.json")
public class {Datasource}Conf extends AbstractArpConf<{Datasource}Conf> {
  private static final String ARP_FILENAME = "arp/implementation/{DatasourceLower}-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.{DatasourceLower}.{Datasource}Driver";
